...
Given the cuts, the honest off-season is **3 workstreams + 2 hardware tasks.**
...
### Total revised off-season: ~78h (down from ~310h rev-4 estimate)
...
| October | Eye E.3 Scout integration (if E.1 solid) | ~10h |
| November | Cockpit D.1 finalize + Elastic Dashboard | ~5h |
| December | Full kickoff simulation dry run (past game) | ~6h |

**This is 8.5 hrs/week average for April–October, then 3–6h in Nov–Dec.
Achievable solo. Every hour produces something usable.**
